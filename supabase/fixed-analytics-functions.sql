-- =====================================================
-- 📊 FIXED ANALYTICS FUNCTIONS - CORRECT COLUMN NAMES
-- =====================================================
...
-- Fixed income breakdown function
...
-- Fixed doctor performance function
...
-- Fixed appointment analytics function
...
-- Fixed treatment analytics function (without created_at)
...
-- Success message
SELECT 'Fixed analytics functions created successfully!' as status;
