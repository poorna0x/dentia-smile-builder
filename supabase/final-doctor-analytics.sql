...
-- Test the function
SELECT 'Testing final doctor analytics function...' as test_step;
...
BEGIN
  ...
  IF clinic_uuid IS NOT NULL THEN
    ...
    RAISE NOTICE '✅ Final doctor analytics function tested successfully for clinic: %', clinic_uuid;
  ELSE
...
-- Success message
SELECT '🎉 Final doctor analytics function created successfully!' as status;
