-- Add tooth images table for storing dental images per tooth
-- This table will store image metadata while actual images are stored in Cloudinary

-- Create tooth_images table
...
-- Policy for all operations on tooth images (following existing pattern)
...
-- Function to delete tooth image (also deletes from Cloudinary via webhook)
