-- =====================================================
-- 🏥 ENHANCED DOCTOR ANALYTICS FUNCTION
-- =====================================================

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS get_enhanced_doctor_analytics(UUID, TEXT, TEXT);

-- Create enhanced doctor analytics function
...
-- Test the function
SELECT 'Testing enhanced doctor analytics function...' as test_step;
...
BEGIN
  ...
  IF clinic_uuid IS NOT NULL THEN
    ...
    RAISE NOTICE '✅ Enhanced doctor analytics function tested successfully for clinic: %', clinic_uuid;
  ELSE
...
-- Success message
SELECT '🎉 Enhanced doctor analytics function created successfully!' as status;
