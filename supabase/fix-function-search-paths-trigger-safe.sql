-- 🔧 Fix Function Search Path Mutability Warnings (Trigger-Safe Version)
-- =====================================================
-- 
-- This script safely fixes all function search path mutability warnings
-- by properly handling trigger dependencies before dropping functions
-- =====================================================
...
-- First, drop all triggers that depend on functions we need to fix
...
-- 4. Fix get_lab_work_summary function (with proper DROP)
...
SELECT 'Function Search Path Mutability Fix Complete (Trigger-Safe Version)!' as status;
